...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar un atleta por nombre");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Ejecuta la opción para consultar los detalles de un atleta.
	 */
	private void ejecutarBuscarAtleta()
	{
		String nombre = input("Nombre: ");
		//Atleta nombre = calculadora.buscarAtleta(nombr);
		System.out.println("El atleta: " + nombre + " es de " + calculadora.countryAtleta(nombre));
		}
